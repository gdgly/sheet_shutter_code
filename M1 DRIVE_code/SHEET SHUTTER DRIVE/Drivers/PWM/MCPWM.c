...
VOID initMCPWM(VOID)
{
	...
	ALTDTR1 = 2*ALTDTR_DIV2;		
	ALTDTR2 = 2*ALTDTR_DIV2;
	ALTDTR3 = 2*ALTDTR_DIV2;
	
	PTCON2 = 0x0000;	/* Divide by 1 to generate PWM */  
//    PWMCON1 = 0x0205;	/* Enable PWM output pins and configure them as */
...
//	PWMCON3 = 0x0205;
	...
	PDC2 = PHASE2 / 2;	
	PDC3 = PHASE3 / 2;
    PR7 = PHASE1; //timer 7 to calculate trigger point
    TRIG1 = PHASE1;

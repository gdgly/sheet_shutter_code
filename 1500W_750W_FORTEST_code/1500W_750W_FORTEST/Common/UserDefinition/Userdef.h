...
#define SPEED_RPM_CALC_750W      ((((DWORD)FCY*60)/(PDIV*2*3)))
#define SPEED_RPM_CALC_1500W      ((((DWORD)FCY*60)/(PDIV*2*4)))

// Period Calculation
// Period = (FCY / PDIV * 60) / (RPM * NO_POLEPAIRS )
#define MINPERIOD_750W	((DWORD)((FCY/PDIV)*60)/((DWORD)MAX_RPM*2*3))
#define MAXPERIOD_750W	((DWORD)((FCY/PDIV)*60)/((DWORD)MIN_RPM*2*3))
...
/* Half of the PWM Deadtime; The effective deadtime written in ALTDTR registers is 2*ALTDTR_DIV2 */
   ...
   #define	ALTDTR_DIV2_750W	196  //2.8us
   #define	ALTDTR_DIV2_1500W   196  //2.8us
#endif

...
VOID writeBYTE(UINT16 address, UINT8 byte)
{
    ...
    do
    {
		if(retryCnt>0) SPI1INTInit();	//20191223 ADD byIME
...
BOOL initMotorControlBlock(VOID)
{
    ...
    {
        uEEPDriveMotorCtrlBlock.stEEPDriveMotorCtrlBlock = uEEP_M2DriveMotorCtrlBlockDefault.stEEPDriveMotorCtrlBlock;

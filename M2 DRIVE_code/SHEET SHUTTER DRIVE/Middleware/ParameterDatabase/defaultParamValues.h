...
//#if 0
//		200,    //UINT16 riseChangeGearPos1_A103;
//		100,    //UINT16 riseChangeGearPos2_A104;
//		0,      //UINT16 riseChangeGearPos3_A105;
//		500,    //UINT16 fallChangeGearPos1_A106;
//		600,    //UINT16 fallChangeGearPos2_A107;
//		0,      //UINT16 fallChangeGearPos3_A108;
//		50,      //UINT8 	shtrRevOperMinLimit_A110;
//#else
//		400,//500,//200,    //UINT16 riseChangeGearPos1_A103;
//		300,//450,//100,    //UINT16 riseChangeGearPos2_A104;
//		100,//200,//250,//0,      //UINT16 riseChangeGearPos3_A105;
//		400,//500,//500,    //UINT16 fallChangeGearPos1_A106;
//		300,//450,//600,    //UINT16 fallChangeGearPos2_A107;
//		200,//200,//250,//0,      //UINT16 fallChangeGearPos3_A108;
//		175,//50,      //UINT8 	shtrRevOperMinLimit_A110;
//#endif
...
//		220,      //UINT16	current_PI_KP_A514;
//		10,      //UINT8	current_PI_KI_A515;
...
CONST _EEPDriveMotorCtrlBlock uEEP_M2DriveMotorCtrlBlockDefault =
{
    .stEEPDriveMotorCtrlBlock =
    {
        0,      //UINT8 decelByPhotoElecBlckingLim_A011;
		...
		200,//100,//200,//250,      //UINT16 riseChangeGearPos3_A105;
		750,//400,//500,    //UINT16 fallChangeGearPos1_A106;
		450,//300,//450,    //UINT16 fallChangeGearPos2_A107;
		200,//200,//250,      //UINT16 fallChangeGearPos3_A108;
...
CONST _EEPDriveCommonBlock uDriveCommonBlockEEPDefault =
{
    .stEEPDriveCommonBlock =
    {
		...
		0,//678,      //UINT16 	currentValueMonitor_A129;
#if 0
		100,    //UINT16 	apertureHeightPos_A130;
#else
		200,    //UINT16 	apertureHeightPos_A130;
#endif

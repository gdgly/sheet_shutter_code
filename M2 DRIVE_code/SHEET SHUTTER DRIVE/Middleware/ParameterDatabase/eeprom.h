...
#define DRIVE_MOTOR_BLOCK_DAT_LENGTH (DECEL_BY_PHOTO_BLCK_LIM_DAT_LEN + WAIT_FOR_STOPPAGE_DAT_LENGTH + RISE_CHANGE_GEAR_POS1_DAT_LENGTH \
									...
									+ JOG_SPEED_DAT_LENGTH + DRIVE_BLOCK_CRC_DAT_LENGTH)
...
typedef union // Drive status register 
{
       ...
       struct stDriveStatus
       {
            ...
            UINT32 shutterBetweenUplmtAphgt	: 1;	//STT AOYAGI shutter position between upperlimit and ApertureHeight
            UINT32 shutterBetweenLowlmtAphgt	: 1;	//STT AOYAGI shutter position between lowerlimit and ApertureHeight

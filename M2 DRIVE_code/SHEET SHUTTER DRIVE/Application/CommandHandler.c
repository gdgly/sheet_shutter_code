...
#define EXPECTED_CRC_STOP_DRIVE 				0xA103
...
#define EXPECTED_CRC_GET_ERROR_LIST				0x6C92
...
CONST UINT32 drive_fw_version = 17102;    //Drive version 1704.1        20170418   201703_No.29
enum {
	no_error = 0,
            ...
            switch(uart_cmd)
            {
                ...
                case open_shutter_aperture_height:
                    ...
                    else
                    {
                        ...
                        FLAG_CMD_open_shutter=1;
                        CMD_open_shutter=open_shutter_aperture_height;  //20161201
                    }
                    break;
                case close_shutter:

...
void initKeys(void)
{
    ...
    MAP_SysCtlPeripheralEnable(WATCHDOG_CHECK_GPIO_PERIPH);

    MAP_GPIODirModeSet(WATCHDOG_CHECK_GPIO_BASE, WATCHDOG_CHECK_PE, GPIO_DIR_MODE_IN);

    MAP_GPIOPadConfigSet(WATCHDOG_CHECK_GPIO_BASE, WATCHDOG_CHECK_PE, GPIO_STRENGTH_2MA, GPIO_PIN_TYPE_STD_WPU);
#endif
    gKeysStatus.Val = 0;

...
const uint8_t gu8_en_oprdelay_DEF = 0;
const uint8_t gu8_modefix_DEF = 0;
const uint8_t gu8_en_switchpan_DEF = 0;
const uint8_t gu8_opr_rsrttmr_DEF = 10;
...
const uint32_t gu32_ctrl_fwver_DEF = 0x00000301; //Read Default Firmware Version
...
uint8_t gu32_intlck_deltmr = 0; //version 0.7D

...
#define FLASH_IMAGE_VERIFICATION_FAILED	6
...
#define FLASH_NUMBER_OF_BLOCKS_FOR_APPLICATION			60

#define FLASH_IMAGE_CRC_ADDRESS		(FLASH_ONE_BLOCK_SIZE * FLASH_NUMBER_OF_BLOCKS_FOR_APPLICATION) +	\
									FLASH_APPLICATION_AREA_STARTING_ADDRESS - FLASH_ONE_WORD_SIZE

#define FLASH_IMAGE_LENGTH_ADDRESS	(FLASH_NUMBER_OF_BLOCKS_FOR_APPLICATION * FLASH_ONE_BLOCK_SIZE) +	\
									FLASH_APPLICATION_AREA_STARTING_ADDRESS - (2 * FLASH_ONE_WORD_SIZE)

#define FLASH_APPLICATION_FLAGS_ADDRESS		(FLASH_NUMBER_OF_BLOCKS_FOR_APPLICATION * FLASH_ONE_BLOCK_SIZE) +	\
											FLASH_APPLICATION_AREA_STARTING_ADDRESS - (3 * FLASH_ONE_WORD_SIZE)

#define FLASH_FIRWARE_UPGRADE_FROM_APP_FLAG		(FLASH_NUMBER_OF_BLOCKS_FOR_APPLICATION * FLASH_ONE_BLOCK_SIZE) +	\

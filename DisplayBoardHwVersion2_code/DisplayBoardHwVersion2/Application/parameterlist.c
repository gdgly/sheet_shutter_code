...
const stParamDatabase gsParamDatabase[TOTAL_PARAMETERS] =
{
		...
		{	21	,	 true	,	 false	,	 false	,	eDestControlBoard	,	"A004 DOWNチエン タイマ"		    ,	eVAL_INT	,	4	,	{	0	,	10	,	(unsigned char *)cucUnitSec				}	,	{	0												,	0	},"A004 DOWN DELAY"	 }	,
		{	22	,	 true	,	 false	,	 false	,	eDestControlBoard	,	"A005 チエンタイマON/OFF"		,	eSTATE		,	5	,	{	0	,	0	,	0										}	,	{	(unsigned char *)cucA005EN_UP_DWN_DELAY_States	,	3,(unsigned char *)cucA005EN_UP_DWN_DELAY_States_english	},"A005 EN UP DWN DELAY"	 }	,
		{	23	,	 true	,	 false	,	 false	,	eDestControlBoard	,	"A006 モードコテイ"				,	eSTATE		,	6	,	{	0	,	0	,	0										}	,	{	(unsigned char *)cucA006AUTO_MAN_MODE_FIX_States,	3,(unsigned char *)cucA006AUTO_MAN_MODE_FIX_States_english	},"A006 AUTO MAN FIXING"	 }	,
		{	24	,	 true	,	 false	,	 false	,	eDestControlBoard	,	"A007 Dユニット SWムコウ"		    ,	eSTATE		,	7	,	{	0	,	0	,	0										}	,	{	(unsigned char *)cucEnable_Disable_State		,	2,(unsigned char *)cucEnable_Disable_State_english	},"A007 EN PANEL SWITCH"	 }	,
		{	25	,	 true	,	 false	,	 false	,	eDestControlBoard	,	"A008 ユキモード"				,	eSTATE	    ,	8	,	{	0	,	0	,	0	                                    }	,	{	(unsigned char *)cucSnow_Mode_State	            ,	3,(unsigned char *)cucSnow_Mode_State_english	},"A008 SNOW MODE"	 }	,
		{	26	,	 true	,	 false	,	 false	,	eDestControlBoard	,	"A009 ドウサセイゲン タイマ"		,	eVAL_INT	,	9	,	{	0	,	30	,	(unsigned char *)cucUnitSec				}	,	{	0												,	0	},"A009 OPR RESTRIC TMR"	 }	,
		{	27	,	 true	,	 false	,	 false	,	eDestControlBoard	,	"A010 I-ロック チエンタイマ"		,	eVAL_INT	,	10	,	{	0	,	2	,	(unsigned char *)cucUnitSec				}	,	{	0												,	0	},"A010 INTERLOCK DELAY"	 }	,
		{	28	,	 true	,	 false	,	 false	,	eDestControlBoard	,	"A016 カコウドウサ セッテイ"		    ,	eSTATE		,	16	,	{	0	,	0	,	0										}	,	{	(unsigned char *)cucCLOSE_OPR_STATE				,	2,(unsigned char *)cucCLOSE_OPR_STATE_english},"A016 CLOSE OPR SET"	 }	,
		{	29	,	 true	,	 false	,	 false	,	eDestDriveBoard	    ,	"A025 メンテナンスカウント"			,	eVAL_INT	,	25	,	{	1	,	9999,	(unsigned char *)cucUnitX1000   	}	,	{	0												,	0	},"A025 MAINTAIN CNT"	 }	,
		...
		{	39	,	 true	,	 false	,	 false	,	eDestControlBoard	,	"A074 OPリレー4"				,	eSTATE		,	74	,	{	0	,	0	,	0										}	,	{	(unsigned char *)cucMult_Func_Out_State			,	11,(unsigned char *)cucMult_Func_Out_State_english},"A074 MULTI FUNC OP 4"	 }	,
		{	40	,	 true	,	 false	,	 false	,	eDestControlBoard	,	"A075 OPリレー5"				,	eSTATE		,	75	,	{	0	,	0	,	0										}	,	{	(unsigned char *)cucMult_Func_Out_State			,	11,(unsigned char *)cucMult_Func_Out_State_english},"A075 MULTI FUNC OP 5"	 }	,
		{	41	,	 true	,	 false	,	 false	,	eDestControlBoard	,	"A078 リモコン センタク"			,	eSTATE		,	78	,	{	0	,	0	,	0										}	,	{	(unsigned char *)cucWR_1PBS_OR_OPEN				,	2,(unsigned char *)cucWR_1PBS_OR_OPEN_english},"A078 WR 1PBS OR OPEN"	 }	,
		{	42	,	 true	,	 true	,	 false	,	eDestDriveBoard		,	"A080 マイクロセンサカウント"		,	eVAL_INT	,	80	,	{	0	,	99		,	0									}	,	{	0												,	0	},"A080 MICRO CNT MON"	 }	,
		{	43	,	 true	,	 true	,	 false	,	eDestDriveBoard		,	"A100 ジョウゲン セットイチ"		    ,	eVAL_INT	,	100	,	{	0	,	9000	,	0									}	,	{	0												,	0	},"A100 UP STP POS"	 }	,
		{	44	,	 true	,	 true	,	 false	,	eDestDriveBoard		,	"A101 カゲン セットイチ"			,	eVAL_INT	,	101	,	{	0	,	9000	,	0									}	,	{	0												,	0	},"A101 LOW STP POS"	 }	,
		{	45	,	 true	,	 true	,	 false	,	eDestDriveBoard		,	"A102 コウデンギリ セットイチ"		,	eVAL_INT	,	102	,	{	0	,	9000	,	0									}	,	{	0												,	0	},"A102 PE POSITION"	 }	,
		{	46	,	 true	,	 false	,	 false	,	eDestDriveBoard		,	"A103 ジョウショウ　ゲンソ ク1"		,	eVAL_INT	,	103	,	{	0	,	9000	,	0									}	,	{	0												,	0	},"A103 RCG POS 1"	 }	,
		{	47	,	 true	,	 false	,	 false	,	eDestDriveBoard		,	"A104 ジョウショウ　ゲンソ ク2"		,	eVAL_INT	,	104	,	{	0	,	9000	,	0									}	,	{	0												,	0	},"A104 RCG POS 2"	 }	,
		{	48	,	 true	,	 false	,	 false	,	eDestDriveBoard		,	"A105 ジョウショウ　ゲンソ ク3"		,	eVAL_INT	,	105	,	{	0	,	9000	,	0									}	,	{	0												,	0	},"A105 RCG POS 3"	 }	,
		{	49	,	 true	,	 false	,	 false	,	eDestDriveBoard		,	"A106 カコウ　ゲンソ ク1"			,	eVAL_INT	,	106	,	{	0	,	9000	,	0									}	,	{	0												,	0	},"A106 FCG POS 1"	 }	,
		{	50	,	 true	,	 false	,	 false	,	eDestDriveBoard		,	"A107 カコウ　ゲンソ ク2"			,	eVAL_INT	,	107	,	{	0	,	9000	,	0									}	,	{	0												,	0	},"A107 FCG POS 2"	 }	,
		{	51	,	 true	,	 false	,	 false	,	eDestDriveBoard		,	"A108 カコウ　ゲンソ ク3"			,	eVAL_INT	,	108	,	{	0	,	9000	,	0									}	,	{	0												,	0	},"A108 FCG POS 3"	 }	,
		{	52	,	 true	,	 false	,	 false	,	eDestDriveBoard		,	"A126 ゲンテンホセイカイスウ"		,	eVAL_INT	,	126	,	{	10	,	9999	,	0									}	,	{	0												,	0	},"A126 COR FRQ APER"	 }	,
		{	53	,	 true	,	 false	,	 false	,	eDestDriveBoard		,	"A127 ゲンテンホセイセッテイ"		,	eSTATE		,	127	,	{	0	,	0		,	0									}	,	{	(unsigned char *)cucYES_NO_State				,	2,(unsigned char *)cucYES_NO_State_english	},"A127 AUT COR EN"	 }	,
		{	54	,	 true	,	 true	,	 false	,	eDestDriveBoard		,	"A128 ゲンテン セットイチ"			,	eVAL_INT	,	128	,	{	0	,	9000	,	0									}	,	{	0												,	0	},"A128 ORG SENS POS"	 }	,
		{	55	,	 true	,	 true	,	 true	,	eDestDriveBoard		,	"A129 ゲンザイノ シートイチ"		,	eVAL_INT	,	129	,	{	0	,	9000	,	0									}	,	{	0												,	0	},"A129 CUR VAL MON"	 }	,
		{	56	,	 true	,	 false	,	 false	,	eDestDriveBoard		,	"A130 ハンカイ セットイチ"			,	eVAL_INT	,	130	,	{	0	,	9000	,	0									}	,	{	0												,	0	},"A130 APR HGT POS"	 }	,
        {	57	,	 true	,	 false	,	 false	,	eDestControlBoard	,	"A131 ハンカイ ON/OFF"		    ,	eSTATE		,	131	,	{	0	,	0	,	0										}	,	{	(unsigned char *)cucYES_NO_State				,	2,(unsigned char *)cucYES_NO_State_english	},"A131 EN APERT HEIGHT"}	,
		//{  41   ,    true   ,    false  ,    false  ,   eDestDisplayBoard   ,   "A200 GUEST ON/OFF"      ,   eSTATE      ,   26 ,   {   0   ,   0   ,   0                                       }   ,   {   (unsigned char *)cucValid_Invalid_State	    ,	2   }    }  ,
		{	58	,	 true	,	 false	,	 false	,	eDestDriveBoard		,	"A522 ジョウショウ ソ クド"	        ,	eSTATE      ,	522	,	{	0	,	0	,	0										}	,	{	(unsigned char *)cucHigh_Low_Normal				,	3,(unsigned char *)cucHigh_Low_Normal_english},"A522 S1 UP"	 }	,
		{	59	,	 true	,	 false	,	 false	,	eDestDriveBoard		,	"A528 カコウ ソ クド"	            ,	eSTATE      ,	528	,	{	0	,	0	,	0										}	,	{	(unsigned char *)cucHigh_Low_Normal				,	3,(unsigned char *)cucHigh_Low_Normal_english},"A528 S1 DOWN"	 }	,

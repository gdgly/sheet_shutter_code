...
uint8_t uploadDrvParametersPaint(void)
{
	...
	{
	gSDCardUPParamDRVbrdMenuItems[i].pcText_japanese = "�t�@�C��_�Z���^�N:";
	}
	else
	{
...
uint8_t uploadCtrlParametersPaint(void)
{
	...
	if(gu8_language == Japanese_IDX)
	{
	gSDCardUPParamCTRLbrdMenuItems[i].pcText_japanese = "�t�@�C��_�Z���^�N:";
	}
	else
	{
...
uint8_t SDUpParamDRVPaint(void)
{
	...
	if(gu8_language == Japanese_IDX)
	{
	displayText("�p�����[�^��SD�J�[�h�j", 2, 0, false, false, false, false,false,false);
	displayText("�R�s�[�V�}�X�J?", 2, 16, false, false, false, false,false,false);
	}
	else
	{
	...
	//					SDULParamValue[j] = 0; //Null character //Adjusted in above code
			...
			else if(UploadParamFlags.flags.paramDriveuploadDone)
			{
				...
				if(0 == lsDelay3SecStart)
				{
					...
					//
					if(gu8_language == Japanese_IDX)
					displayText("�R�s�[�J�������E", 2, 0, false, false, false, false, false, false);
					else
...
uint8_t SDUpParamDRVEnter(void)
{
	...
	if(gKeysStatus.bits.Key_Enter_pressed)
	{
		...
		if(gu8_language == Japanese_IDX)
		{
			displayText("SD�J�[�h�փR�s�[", 2, 0, false, false, false, false, false, false);
		displayText("�J�������E", 2, 16, false, false, false, false,false,false);

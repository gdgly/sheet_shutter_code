...
//CYW 用来分割数据的
//int
//usnprintf_E03_cyw(char * s, size_t n, const char * restrict t)
//{
//	uint8_t tp_i=10;
//	s[1]= t[0];
//	s[3]= t[1];
...
////CYW 用来分割数据用的
//int
//usnprintf_D05_cyw(char * s, size_t n, const char * restrict t)
//{
//
//	s[1]= t[0];
//	s[3]= t[1];
...
////CYW 用来分割数据用的
//int
//usnprintf_D07_cyw(char * s, size_t n, const char * restrict t)
//{
//
//	s[1]= t[0];
//	s[3]= t[1];
...
////CYW 用来分割数据用的
//int
//usnprintf_UU_cyw(char * s, size_t n, const char * restrict t)
//{
//
//	uint8_t tp_i=0;
//	for(tp_i=0;tp_i<18;tp_i++)
//	    s[tp_i]= t[tp_i];
//	for(tp_i = 0;tp_i<n;tp_i++)
//	{
//		s[19+tp_i*2]= t[18+tp_i];
//	}
//	//s[19]= t[18];//冒号
//	//s[21]= t[19];//数 2
//	s[19+n*2-1]=0;
...
////CYW 用来分割数据用的
//int
//usnprintf_nU_cyw(char * s, size_t n, const char * restrict t)
//{
//
//	uint8_t tp_i=0;
//	for(tp_i=0;tp_i<n;tp_i++)
...
//}
//
//uint8_t data_long_cyw(uint32_t x_data)
//{
//	//if((x_data/10000000)!=0) return 7;
//	if((x_data/1000000)!=0) return 7;
//	if((x_data/100000)!=0) return 6;
//	if((x_data/10000)!=0) return 5;
//	if((x_data/1000)!=0) return 4;
//	if((x_data/100)!=0) return 3;
//	if((x_data/10)!=0) return 2;
//	return 1;
//}
//*****************************************************************************
//

...
*/
		...
		{	21	,	"PE OBSTACLE"		,	RECOVERABLE		,	NONRECORDABLE_ANOMALY	,	ON						,	OFF						,	DISPLAY_INDICATION		,	DRIV	,	0	,	&guiDriveApplicationFaultCopy	,	0	,	&luiLastDriveApplicationFault	,	0	,"コウデンセンサON"				,OPEN_ONLY}	,

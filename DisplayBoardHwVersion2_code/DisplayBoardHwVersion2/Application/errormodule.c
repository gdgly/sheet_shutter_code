...
*/
		...
		{	13	,	"DRV OVER CURENT"	,	NONRECOVERABLE	,	RECORDABLE_ANOMALY		,	ON						,	_FLASH_STATUS_COUNT_3	,	DISPLAY_INDICATION		,	DRIV	,	1	,	&guiDriveMotorFaultCopy			,	2	,	&luiLastDriveMotorFault			,	2	,"OC.OHエラー"					,NONE_OPEN_CLOSE}	,
		...
		{	16	,	"DRV MTR STALL"		,	NONRECOVERABLE	,	RECORDABLE_ANOMALY		,	ON						,	_FLASH_STATUS_COUNT_1	,	DISPLAY_INDICATION		,	DRIV	,	1	,	&guiDriveMotorFaultCopy			,	5	,	&luiLastDriveMotorFault			,	5	,"カフカエラー"					,NONE_OPEN_CLOSE}	,
		{	17	,	"DRV OVERHEAT"		,	RECOVERABLE		,	RECORDABLE_ANOMALY		,	ON						,	_FLASH_STATUS_COUNT_4	,	DISPLAY_INDICATION		,	DRIV	,	1	,	&guiDriveMotorFaultCopy			,	6	,	&luiLastDriveMotorFault			,	6	,"OC.OHエラー"				,NONE_OPEN_CLOSE}	,
		{	18	,	"MTR SUSTAIN"		,	RECOVERABLE		,	RECORDABLE_ANOMALY		,	ON						,	_FLASH_STATUS_COUNT_1	,	DISPLAY_INDICATION		,	DRIV	,	1	,	&guiDriveMotorFaultCopy			,	7	,	&luiLastDriveMotorFault			,	7	,"カフカエラー"					,NONE_OPEN_CLOSE}	,
		{	19	,	"MTR PWM COAST"		,	RECOVERABLE		,	NONRECORDABLE_ANOMALY	,	ON						,	_FLASH_STATUS_COUNT_1	,	DISPLAY_INDICATION		,	DRIV	,	1	,	&guiDriveMotorFaultCopy			,	8	,	&luiLastDriveMotorFault			,	8	,"カフカエラー"					,NONE_OPEN_CLOSE}	,
		...
		{	21	,	"PE OBSTACLE"		,	RECOVERABLE		,	NONRECORDABLE_ANOMALY	,	OFF						,	_FLASH_STATUS_COUNT_1	,	DISPLAY_INDICATION		,	DRIV	,	1	,	&guiDriveApplicationFaultCopy	,	0	,	&luiLastDriveApplicationFault	,	0	,"コウデンセンサON"				,OPEN_ONLY}	,

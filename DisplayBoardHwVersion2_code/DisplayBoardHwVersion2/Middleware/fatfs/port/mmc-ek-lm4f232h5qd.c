...
// Added - Girish - Patch for RTC FAT Time - get_fattime()
#include <time.h>
#include "Middleware/rtc.h"
//struct tm currentDateTime; //Fetch current time using RTCGet()
...
//
// Patch added for RTC Timing - Girish
//
DWORD get_fattime (void)
{
//    RTCGet(&currentDateTime);
//    DWORD fattime = ((currentDateTime.tm_year - 80) << 25) |
//    				(currentDateTime.tm_mon << 21) |
//    				(currentDateTime.tm_mday << 16) |
//    				(currentDateTime.tm_hour << 11) |
//    				(currentDateTime.tm_min << 5) |
//    				(15UL <<1);
//    return fattime;
    ...
    year = ((currentDateTime.tm_year - 80) << 25);
    month = (currentDateTime.tm_mon+1 << 21);
    day = (currentDateTime.tm_mday << 16);
    hour = (currentDateTime.tm_hour << 11);
    min = (currentDateTime.tm_min << 5);
    sec = (15UL <<1);
    unsigned long fattime = year | month | day | hour | min | sec;
